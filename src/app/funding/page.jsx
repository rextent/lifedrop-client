      ...
      <section className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="relative bg-gradient-to-br from-red-600 to-rose-700 p-6 text-white sm:p-8">
            ...
            <div className="relative z-10 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
              ...
              <button
                type="button"
                onClick={() =>
                  toast("Stripe payment will be added in the next step.")
                }
                className="inline-flex h-12 items-center justify-center gap-2 rounded-xl bg-white px-5 text-sm font-black text-red-600 shadow-lg shadow-red-900/10 transition hover:bg-red-50"
              >
                <FaMoneyBillWave />
                Give Fund
              </button>
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Total successful funding amount.
              </p>
            </div>
        ...
        <div className="rounded-3xl border border-slate-100 bg-white shadow-sm">
          <div className="border-b border-slate-100 p-5">
            ...
            <p className="mt-1 text-sm text-slate-500">
              Showing all successful funding records made by users.
            </p>
          </div>
